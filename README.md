...
Déploiement automatisé d'une infrastructure GLPI haute disponibilité sur un cluster Docker Swarm de 3 nœuds, provisionné par Terraform et configuré par Ansible.

## Architecture

- **3 VMs Ubuntu 22.04** (KVM/libvirt via Terraform) : 1 Manager + 2 Workers
...
3. Provisionnement des 3 VMs (Terraform + KVM/libvirt)
